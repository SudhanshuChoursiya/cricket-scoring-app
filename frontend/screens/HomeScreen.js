...
const HomeScreen = ({
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener("focus", () => {
      ...
      dispatch(setStrikeBatsman({
        _id: null, name: null
      }));
      dispatch(setNonStrikeBatsman({
        _id: null, name: null
      }));
                    ...
                    <View
                      ...
                      <View
                        style={[
                          ...
                          match.matchStatus ===
                          "completed"
                          ? styles.bg_green: match.matchStatus ===
                          "abandoned"
                          ? styles.bg_red: styles.bg_orange
                        ]}
                        >
                        <Text
                      ...
                      <Text style={styles.match_info}>
                        ...
                        (match.matchResult
                          ...
                          ? `${ellipsize(
                            ...
                            .winningTeam,
                            35
                          )} won the super over`: match.matchResult
                          .status ===
                          "Super Over Tie"
                          ? "Super Over Tied": "")}
                        {match.matchStatus ===
