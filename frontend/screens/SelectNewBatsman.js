...
const SelectNewBatsman = ({ navigation, route }) => {
    ...
    const [changeBatsmanMutation, { isLoading: isChangingBatsman }] =
        useChangeBatsmanMutation();
    const [changeOutBatsmanMutation, { isLoading: isChangingOutBatsman }] =
        useChangeOutBatsmanMutation();
    ...
    const currentBatsmen = currentInningDetails?.currentBatsmen || null;
    ...
    const handleChangeOutBatsman = async () => {
        try {
            ...
            await changeOutBatsmanMutation({
                matchId: route.params?.matchId,
                newBatsmanId: selectedPlayer._id
            }).unwrap();
            navigation.goBack();
                ...
                <>
                    ...
                    {selectedPlayer && (
                        <View style={styles.confirm_btn_wrapper}>
                            ...
                            >
                                {!(
                                    isChangingBatsman || isChangingOutBatsman
                                ) ? (
