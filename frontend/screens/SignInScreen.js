      ...
      <View style={styles.other_details_wrapper}>
        ...
        <View style={styles.about_us_paragraph_container}>
          <Text style={styles.about_us_paragraph}>
            CricPro is your ultimate app for live cricket scoring. Update match
            scores in real-time and keep your audience informed with every
            moment of the game.
          </Text>
        </View>
        ...
        <View style={styles.tagline_container}>
          <Text style={styles.tagline}>Keep The Score — Live The Game</Text>
        </View>
      </View>
    </View>
  );
